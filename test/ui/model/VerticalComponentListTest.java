...
class VerticalComponentListTest {
	...
	private Component comp4 = new CheckBox(0, 0, this.width, 500, false, UUID.randomUUID(), ChangeEventType.REPAINT);
	private Component comp5 = new CheckBox(0, 0, 678, this.height, false, UUID.randomUUID(), ChangeEventType.REPAINT);
	...
	void test1ConstructorWithInitParams() {
		...
		assertAll(() -> assertTrue(x == vc.getX()), () -> assertTrue(y == vc.getY()),
				() -> assertTrue(width == vc.getWidth()), () -> assertTrue(height == vc.getHeight()));
	}
	...
	void test3ConstructorWithNegativeCoords() {
		Exception e = assertThrows(IllegalArgumentException.class,
				() -> vc = new VerticalComponentList(-1, y, width, height));
