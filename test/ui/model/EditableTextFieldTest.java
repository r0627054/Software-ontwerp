...
class EditableTextFieldTest {
	...
	void test() {
		UUID id = UUID.randomUUID();
		etextf = new EditableTextField("testString", id, ChangeEventType.REPAINT, null, null);
	...
	void test2MouseClickedCount1WithinComponent() {
		etextf = new EditableTextField(x, y, width, height, testValue, id, ChangeEventType.REPAINT, null, null);
		etextf.mouseClicked(MouseEvent.MOUSE_PRESSED, x + 1, y + 1, 1);
	...
	void test3MouseClickedCount1WithinComponent() {
		etextf = new EditableTextField(x, y, width, height, testValue, id, ChangeEventType.REPAINT, null, null);
		etextf.mouseClicked(MouseEvent.MOUSE_PRESSED, x, y, 1);
	...
	void test4MouseClickedCountTwiceWithinComponent() {
		etextf = new EditableTextField(x, y, width, height, testValue, id, ChangeEventType.REPAINT, null, null);
		etextf.mouseClicked(MouseEvent.MOUSE_PRESSED, x + 1, y + 1, 2);
		assertFalse(etextf.isSelected());
	}
	...
	void test5OnErrorSetSelectedAndReturnCursorPosition() {
		...
		assertAll(() -> assertTrue(etextf.isSelected()),
	...
	void test11PressLetterOrDigitWhenSelected() {
		...
		assertAll(() -> assertEquals(textBefore + myChar, etextf.getText()),
				() -> assertTrue(positionBefore < etextf.getPosition()));
	}
	...
	void test14PressBackSpaceWhenSelected() {
		...
		assertAll(() -> assertNotEquals(textBefore, etextf.getText()),
				() -> assertEquals(positionBefore - 2, etextf.getPosition()));
	}
	...
	void test16PressEscapeWhenSelected() {
		...
		assertAll(() -> assertEquals(etextf.getDefaultValue(), etextf.getText()),
				() -> assertFalse(etextf.isSelected()));
	}

	/**
	 * Test 17 : Trigger anything other than MouseEvent.MOUSE_PRESSED
	 */
	@Test
	...
	void test21OutsideClick() {
		etextf = new EditableTextField(x, y, width, height, testValue, id, ChangeEventType.REPAINT, null, null);
		etextf.outsideClick(MouseEvent.MOUSE_PRESSED, x - 20, y - 20, 1);
		assertFalse(etextf.isSelected());
